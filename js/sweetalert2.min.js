! function(e, t) {
                ...
                var K = function(e, t) {
                    ...
                    D = function(t) {
                        ...
                        if ([9, 13, 32, 27].indexOf(r) !== -1) {
                            ...
                            9 === r ? (n.shiftKey ? K(s, -1) : K(s, 1), n.stopPropagation(), n.preventDefault()) : 13 === r || 32 === r ? s === -1 && l.allowEnterKey && (l.focusCancel ? q(j, n) : q(H, n)) : 27 === r && l.allowEscapeKey === !0 && (e.closeModal(l.onClose), o("esc"))
                        }
                    };
    ...
    return $.isVisible = function() {
        ...
        return new Promise(function(e, o) {
            ! function r(i, a) {
                0 < D.length ? (document.body.setAttribute("data-swal2-queue-step", 0), $(D[0]).then(function(e) {
                    n.push(e), r(1, void 0)
                }, function(e) {
                    t(), o(e)
                })) : (t(), e(n))
        ...
        K = j({}, e)
    }, $.noop = function() {}, $.version = "6.4.3", $.default = $, $
